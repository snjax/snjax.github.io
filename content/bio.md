...
- [**Plasma Prime design proposal**](https://ethresear.ch/t/plasma-prime-design-proposal/4222) (Nov 12, 2018) — one complete public draft *within* the pre-existing Plasma Prime family (Plasma Cashflow improved with RSA accumulators and range chunking); 8,300+ views
...
| Feb 2026 | [Basic Block podcast #216](https://basicblockradio.com/e216/) — "ИИ-аудиты в Web3" (Russian) | AI audits in Web3 — SavantChat | [video](https://www.youtube.com/watch?v=EudACqKiTMM) · [transcript (EN)](/transcripts/basic-block-216/) · [RU](/transcripts/basic-block-216-ru/) |
